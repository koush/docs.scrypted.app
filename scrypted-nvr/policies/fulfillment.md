...
Support issues related to unrelated to the Scrypted NVR product (HomeKit, Google Home, etc) will only receive community support. Support for subscribers is only for the Scrypted NVR product.
